...
namespace nrlmsise
{
    ...
    internal static class Data
    {
        public static void SetData()
        {
            ...
            #region Density
            Calculations.pd = new double[9][];

            //HE DENSITY
            Calculations.pd[0] = new double[]
            {
            ...
            #region Turbo
            Calculations.pdl = new double[2][];
            Calculations.pdl[0] = new double[]
            {
            ...
            #region TN & TGN Values
            Calculations.ptl = new double[4][];
            //TN1(2)
            Calculations.ptl[0] = new double[]
            {
            ...
            Calculations.pma = new double[10][];
            //TN2(2)
            Calculations.pma[0] = new double[]
            {
            ...
            #region Semiannual Mult Sam
            Calculations.sam = new double[]
            {
            ...
            #region Middle Atmosphere Averages
            Calculations.pavgm = new double[]
            {
            ...
            #region Others
            Calculations.plg = new double[4][];
            
            for (int i = 0; i < 4; i++)
            {
                Calculations.plg[i] = new double[9];
            }
            #endregion
        }
    }
