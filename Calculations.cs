...
;        }
        ...
        public static void PrintOutput(Output[] inputSolutions)
        {
            string jsonOutput = "";
            ScientificDisplay scientificRepresentation;
            for (int i = 0; i < inputSolutions.Length; i++)
            {
                scientificRepresentation = new ScientificDisplay(inputSolutions[i]);
                jsonOutput += "\nTest #" + i + "\n";
                jsonOutput += JsonConvert.SerializeObject(scientificRepresentation);
            }
            System.IO.File.WriteAllText(@"C:\Users\Training23\Desktop\project1\output.json", jsonOutput);
        }

        static void DisplayParams(Input[] input, Output[] output)
        {
            for (int i = 0; i < 3; i++)
            {
                Console.Write("\n");
                Console.Write("\nDAY   ");
                for (int j = 0; j < 5; j++)
                    Console.Write("         " + input[i * 5 + j].DayOfYear);
                Console.Write("\nUT    ");
                for (int j = 0; j < 5; j++)
                    Console.Write("       " + input[i * 5 + j].Seconds);
                Console.Write("\nALT   ");
                for (int j = 0; j < 5; j++)
                    Console.Write("         " + input[i * 5 + j].Altitude);
                Console.Write("\nLAT   ");
                for (int j = 0; j < 5; j++)
                    Console.Write("          " + input[i * 5 + j].G_lat);
                Console.Write("\nLONG  ");
                for (int j = 0; j < 5; j++)
                    Console.Write("         " + input[i * 5 + j].G_long);
                Console.Write("\nLST   ");
                for (int j = 0; j < 5; j++)
                    Console.Write("       " + input[i * 5 + j].Lst);
                Console.Write("\nF107A ");
                for (int j = 0; j < 5; j++)
                    Console.Write("         " + input[i * 5 + j].F107A);
                Console.Write("\nF107  ");
                for (int j = 0; j < 5; j++)
                    Console.Write("         " + input[i * 5 + j].F107);
                Console.Write("\n\n");

                Console.Write("\nTINF  ");
                for (int j = 0; j < 5; j++)
                    Console.Write("     " + output[i * 5 + j].Temperature[0]);
                Console.Write("\nTG    ");
                for (int j = 0; j < 5; j++)
                    Console.Write("     " + output[i * 5 + j].Temperature[1]);
                Console.Write("\nHE    ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[0]);
                Console.Write("\nO     ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[1]);
                Console.Write("\nN2    ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[2]);
                Console.Write("\nO2    ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[3]);
                Console.Write("\nAR    ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[4]);
                Console.Write("\nH     ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[6]);
                Console.Write("\nN     ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[7]);
                Console.Write("\nANM 0 ");
                for (int j = 0; j < 5; j++)
                    Console.Write("  " + output[i * 5 + j].Densities[8]);
                Console.Write("\nRHO   ");
                for (int j = 0; j < 5; j++)
                    Console.Write("   " + output[i * 5 + j].Densities[5]);
                Console.Write("\n");
            }
            Console.Write("\n");
        }
